...
function displayhelp {
  echo "Usage: $0 [ --help] [--host] [--domain] [--ipconfig] [--os] [--cpu] [--memory] [--disk] [--printer]" 
  echo "Options:"
  echo " --help       Show this help message and exit"
  echo " --host       Display hostname"
  echo " --domain     Display domain name"
  echo " --ipconfig   Display network configuration"
  echo " --os         Display opearating system name  and version"
  echo " --cpu        Display cpu information"
  echo "  --memory    Display memory information"
  echo " --disk       Display disk usage information"
  echo "  --printer   Display printer list"
}
